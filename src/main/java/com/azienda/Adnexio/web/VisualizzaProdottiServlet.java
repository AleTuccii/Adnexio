...
public class VisualizzaProdottiServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			List<Prodotto> prodotti = bL.visualizzaProdotti();
			req.setAttribute(Constants.CHIAVE_RICERCA_RISULTATO, prodotti);
			aggiungiImmagini(req, prodotti);
			req.getRequestDispatcher("/jsp/privata/admin/visualizzaProdotti.jsp").forward(req, resp);
		} catch (Exception e) {
			e.printStackTrace();
