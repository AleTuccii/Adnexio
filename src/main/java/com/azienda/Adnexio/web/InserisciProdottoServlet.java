...
public class InserisciProdottoServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			bL.inserisciProdotto(titolo, genere, piattaforma, ddr, sviluppatore, editore, localizzazione, disponibilita,
					pegi, prezzo, immagine, nomeImmagine);
			req.setAttribute(Constants.CHIAVE_PRODOTTO_INSERITO, "Prodotto inserito con successo");
